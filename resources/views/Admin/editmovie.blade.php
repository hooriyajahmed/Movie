        ...
        <div class="row justify-content-center text-center">
            ...
            <div class="col-md-8">
                <div class="dark-form">
                    ...
                    <form action="{{ route('updatemovie',$data->id) }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="mb-3">
                            <textarea name="desc"
                                      class="form-control dark-input"
                                      rows="3"
                                      placeholder="Description">{{ $data->desc }}</textarea>
                            @error('desc')
                                <p class="text-danger mt-1">{{ $message }}</p>
                            @enderror
                        </div>
                        ...
                        <div class="mb-3 text-center">
                            <input type="file" name="pic"
                                   class="form-control dark-input">
                            <img src="{{ url('storage/movie/'.$data->picture) }}"
                                 class="mt-3"
