	...
	<div class="container">
		<nav class="navbar navbar-default navbar-custom">
				...
				<div class="navbar-header logo">
				    ...
				    <a href="index-2.html"><img class="logo" src="{{asset('User/images/logo1.png')}}" alt="" width="119" height="58"></a>
			    </div>
	...
	<div class="container">
		<div class="flex-parent-ft">
			<div class="flex-child-ft item1">
				 <a href="index-2.html"><img class="logo" src="{{asset('User/images/logo1.png')}}" alt=""></a>
...
<script src="{{asset('User/js/plugins2.js')}}"></script>
